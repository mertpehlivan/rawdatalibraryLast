...
import { Business } from '@mui/icons-material'; // Assuming you have icons imported for visuals

const CompanyTestReportForm = () => {
  ...
  useEffect(() => {
    if (Object.keys(publication.data).length === 0) {
      const initialCompanyTestReport = {
        title: '',
        date: '',
        companyName: '',
        comment: '',
      ...
      updateData(initialCompanyTestReport);
    }
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={6}>
                <TextField
                  ...
                  label="Company Name"
                  name="companyName"
                  value={publication.data.companyName}
                  onChange={handleChange}
                />
              </Grid>
              <Grid item xs={12}>
...
export default CompanyTestReportForm;
