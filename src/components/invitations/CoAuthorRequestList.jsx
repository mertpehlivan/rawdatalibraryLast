...
const CoAuthorRequestList = () => {
    ...
    const fetchCoAuthorRequests = async (page, size, statusFilter) => {
        setLoading(true);
        try {
            const response = await getCoAuthorRequests(token, page - 1, size, statusFilter);
...
export default CoAuthorRequestList;
