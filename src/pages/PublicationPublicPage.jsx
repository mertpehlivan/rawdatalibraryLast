...
import { getPublicationPage, getPublicationPublicPage } from '../services/publicationService';
...
const PublicationPublicPage = () => {
    ...
    useEffect(() => {
        const fetchPublication = async () => {
            try {
                const data = await getPublicationPublicPage(id);
                console.log(data)
                setPublication(data);
            } catch (error) {
            ...
            <Paper sx={{ padding: 2, borderRadius: 3 }}>
                <Stack spacing={2}>
                    ...
                    >
                        ...
                        <PostActionButton data={publication} publicStatus={true}/>
                    </Stack>
                    <Stack spacing={1}>
...
export default PublicationPublicPage;
